                    ...
                    <div class="card mx-2 my-2" style="min-height:28rem;">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="detai-buku">
                                ...
                                <p class="card-text m-0">Penerbit : <a href="#"
                                        style="text-decoration: none;">{{ $item->penerbit }}</a></p>
                                <p class="card-text">Tahun Terbit : <a href="#"
                                        style="text-decoration: none;">{{ $item->tahun_terbit }}</a></p>
                            </div>
                            @if (Auth::user()->isAdmin == 1)
                                <div class="button-area">
                                    ...
                                    <button class="btn-sm btn-danger px-4"><a data-toggle="modal"
