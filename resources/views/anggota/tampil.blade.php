          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-info"><a href="/anggota/{{ $item->id }}" style="text-decoration: none; color:white;">Detail</a></button>
                    <button class="btn btn-warning"><a href="/anggota/{{ $item->id }}/edit" style="text-decoration: none;color:white">Edit</a></button>
