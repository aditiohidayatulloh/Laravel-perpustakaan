          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-info"><a href="/kategori/{{ $item->id }}" style="text-decoration: none; color:white;">Detail</a></button>
                    <button class="btn btn-warning"><a href="/kategori/{{ $item->id }}/edit" style="text-decoration: none;color:white">Edit</a></button>
                    <button class="btn btn-danger"><a data-toggle="modal" data-target="#DeleteModal">Delete</a></button>
